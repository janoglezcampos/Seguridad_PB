...
static ArrayList <byte []> full = new ArrayList <byte[]>();
	      ...
	      new Thread() {
	         public void run() {
	            try {
	               ...
	               System.out.println("TAMA�O FILE ECRIPTADO "+ full.get(0).length);
	               
	               System.out.println("Input entrante");
	               full.add(input.readNBytes(input.readInt()));
	               System.out.println("TAMA�O PARAMETROS "+ full.get(1).length);
	               
	               System.out.println("Input entrante");
	               full.add(input.readNBytes(input.readInt()));
	               System.out.println("TAMA�O CLAVE ENCRIPTADA "+ full.get(2).length);

	               System.out.println("Input entrante");
	               full.add(input.readNBytes(input.readInt()));
	               System.out.println("TAMA�O FIRMA  "+ full.get(3).length);
	               ...
	               System.out.println("Input entrante");
	               full.add(input.readNBytes(input.readInt()));
	               System.out.println("TAMA�O CERTFIRMA "+ full.get(4).length);
	               
	               System.out.println("Input entrante");
	               full.add(input.readNBytes(input.readInt()));
	               System.out.println("TAMA�O CERTCIFRADO "+ full.get(5).length);
	            	   ...
	            	   System.out.println("Input entrante");
		               full.add(input.readNBytes(input.readInt()));
		               System.out.println("TAMA�O FILE "+ full.get(0).length);

		               System.out.println("Input entrante");
		               full.add(input.readNBytes(input.readInt()));
		               System.out.println("TAMA�O FIRMA  "+ full.get(1).length);
		               ...
		               System.out.println("Input entrante");
		               full.add(input.readNBytes(input.readInt()));
		               System.out.println("TAMA�O CERTFIRMA "+ full.get(2).length);
		               
		               System.out.println("Input entrante");
		               full.add(input.readNBytes(input.readInt()));
		               System.out.println("TAMA�O CERTCIFRADO "+ full.get(3).length);
	               ...
	               if (confidencialidad.equals("PRIVADO")) {  
	            	  	...
	            	  	//Pasamos al desencriptado  
	       				...
	       				cipher.init(Cipher.DECRYPT_MODE,  server.getKeymanagers().getKey(name,clave));
	       				...
	       				System.out.println("Tama�o de clave de desencriptado "+key.getEncoded().length);
