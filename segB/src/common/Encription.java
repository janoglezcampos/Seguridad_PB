...
public class Encription {
	public static byte[] decriptFilePGP(byte[] encriptedKey, byte[] encriptedFile, byte[] cipherParams, String pass,
			String entryAlias, KeyStore keystore) throws Exception {
	...
	public static byte[] decriptDocument(byte[] document, String keyAlias, String password, String algorithm,
			byte[] cipherParams, KeyStore keystore) throws Exception {
	...
	public static ArrayList<byte[]> encriptDocument(byte[] document, String keyAlias, String password, String algorithm,
